 <?php
	...
	")->result_array();
        ...
        public function hapus_kuisoner_harapan()
        {
            $this->db->truncate('kuisioner_harapan');
            redirect('Rekapitulasi_Harapan');
        }
        public function hapus_kuisoner_persepsi()
        {
            $this->db->truncate('kuisioner_persepsi');
            redirect('Rekapitulasi_Persepsi');
        }
    }
